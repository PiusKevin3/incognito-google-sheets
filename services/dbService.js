...
module.exports = {
  ...
  upsertBudgetEntry: async (flat, updatedAt) => {
    ...
    const values = [
      ...
      flat.manifest,
      flat.stage_name,
      parseInt(flat.planned_people) ?? null,
      parseInt(flat.planned_coasters) ?? null,
      parseInt(flat.planned_buses) ?? null,
      parseInt(flat.planned_taxis) ?? null,
      parseInt(flat.cost_per_head) ?? null,
      parseInt(flat.total_cost) ?? null,
      parseInt(flat.contribution) ?? null,
